...
CUSTOM_EMOJIS = {
    ...
    "crown": '<tg-emoji emoji-id="">🏆</tg-emoji>',
    "star": '<tg-emoji emoji-id="">⭐</tg-emoji>',
    "fire": '<tg-emoji emoji-id="">🔥</tg-emoji>',
    ...
    "warning": '<tg-emoji emoji-id="">⚠️</tg-emoji>',
    "info": '<tg-emoji emoji-id="">ℹ️</tg-emoji>',
    "help": '<tg-emoji emoji-id="">🆘</tg-emoji>',
    "admin": '<tg-emoji emoji-id="">👑</tg-emoji>',
    "user": '<tg-emoji emoji-id="">👤</tg-emoji>',
    "registered": '<tg-emoji emoji-id="">📊</tg-emoji>',
    "send": '<tg-emoji emoji-id="">📨</tg-emoji>',
    "broadcast": '<tg-emoji emoji-id="">📢</tg-emoji>',
    "ban": '<tg-emoji emoji-id="">🚫</tg-emoji>',
